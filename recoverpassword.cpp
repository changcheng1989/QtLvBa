...
void RecoverPassword::mousePressEvent(QMouseEvent *event)
{
...
void RecoverPassword::mouseMoveEvent(QMouseEvent *event)
{
    //若鼠标左键被按下
    if(mouse_press)
    {
...
void RecoverPassword::mouseReleaseEvent(QMouseEvent *event)
{
    //设置鼠标为未被按下
    mouse_press = false;
}

void RecoverPassword::showMaxRestore()
{
